...
from meghnad.repo.obj_det.yolov7.models.experimental import *
from meghnad.repo.obj_det.yolov7.utils.autoanchor import check_anchor_order
from meghnad.repo.obj_det.yolov7.utils.general import make_divisible, check_file, set_logging
from meghnad.repo.obj_det.yolov7.utils.torch_utils import time_synchronized, fuse_conv_and_bn, model_info, scale_img, initialize_weights, \
    select_device, copy_attr
from meghnad.repo.obj_det.yolov7.utils.loss import SigmoidBin
    ...
    def forward(self, x):
        ...
        for i in range(self.nl):
            ...
            x[i + self.nl] = x[i + self.nl].view(
                bs, self.na, self.no, ny, nx).permute(0, 1, 3, 4, 2).contiguous()
